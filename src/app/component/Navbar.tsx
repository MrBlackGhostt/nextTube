      ...
      <nav className="flex justify-between items-center p-2 bg-white border-b border-gray-200">
        ...
        <div className="flex items-center">
          ...
          <div className="flex items-center ml-4">
            <Image src="/images/butterlfy.webp" alt="YouTube" width={90} height={20} />
          </div>
        </div>
        ...
        <div className="hidden md:flex items-center justify-center flex-grow mx-8">
          <div className="flex items-center w-full max-w-[600px]">
            ...
            />
            <button onClick={(e)=> handleSearch(e)} className="px-6 py-2 bg-gray-100 border border-l-0 border-gray-300 rounded-r-full hover:bg-gray-200">
